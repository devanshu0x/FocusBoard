...
function SettingsModule(){
  ...
  return (
    <div className=" m-6 mt-18 rounded-lg">
      ...
      <div className="border border-b-3 backdrop-blur-sm bg-background/20 border-r-3 border-[#50fa7b] rounded-lg shadow-3xl px-8 py-4 max-h-116 md:max-w-3xl mx-auto overflow-y-auto text-xs sm:text-sm ">
